...
import type { DistrictType, MetricM03Filters } from "../../types";
...
interface Props {
  filters: MetricM03Filters;
  onChange: (filters: MetricM03Filters) => void;
}
...
export default function AgeDemographicsFilters({ filters, onChange }: Props) {
  ...
  return (
    <div style={{ display: "flex", flexWrap: "wrap", gap: 16, alignItems: "flex-start" }}>
      <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
        <span
          id="m03-filter-district-hierarchy-label"
        ...
        <HTMLSelect
          aria-labelledby="m03-filter-district-hierarchy-label"
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
        <span
          id="m03-filter-gender-label"
          className={Classes.TEXT_MUTED}
          style={{ fontSize: 12, textTransform: "uppercase", letterSpacing: "0.32px" }}
        >
          Gender
        </span>
        <div role="group" aria-labelledby="m03-filter-gender-label" style={{ display: "flex", gap: 4, flexWrap: "wrap" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
        <span
          id="m03-filter-city-class-label"
          className={Classes.TEXT_MUTED}
          style={{ fontSize: 12, textTransform: "uppercase", letterSpacing: "0.32px" }}
        >
          City Class
        </span>
        <div role="group" aria-labelledby="m03-filter-city-class-label" style={{ display: "flex", gap: 4, flexWrap: "wrap" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
        <span
          id="m03-filter-income-label"
          className={Classes.TEXT_MUTED}
          style={{ fontSize: 12, textTransform: "uppercase", letterSpacing: "0.32px" }}
        >
          Income Bracket
        </span>
        <div role="group" aria-labelledby="m03-filter-income-label" style={{ display: "flex", gap: 4, flexWrap: "wrap" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
        <span
          id="m03-filter-voter-status-label"
          className={Classes.TEXT_MUTED}
          style={{ fontSize: 12, textTransform: "uppercase", letterSpacing: "0.32px" }}
        >
          Voter Status
        </span>
        <div role="group" aria-labelledby="m03-filter-voter-status-label" style={{ display: "flex", gap: 4, flexWrap: "wrap" }}>
